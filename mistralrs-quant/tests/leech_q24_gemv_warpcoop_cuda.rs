//! Q24-tANS Phase B.1 warp-cooperative fused GEMV correctness + bench.
//!
//! Mirrors `leech_q24_gemv_cuda.rs` exactly, but invokes
//! [`leech_q24_gemv_bf16_warpcoop`] instead of `leech_q24_gemv_bf16`.
//! The CPU reference, tensor inputs, and tolerance gate are identical;
...
use mistralrs_quant::leech_q24::{
    compute_tile_bit_offsets, init_tables, leech_q24_gemv_bf16_warpcoop,
};
...
#[test]
fn gemv_bf16_warpcoop_matches_cpu_reference() {
    ...
    eprintln!(
        "[warpcoop] tensor {} R={} B={} K_total={} n_blocks={} n_tiles={} sid={} w_offset={} k_beta={} k_offset={} has_offset={}",
        ...
        .unwrap_or(false)
    {
        ...
        eprintln!(
            "BENCH leech_q24_gemv_bf16_warpcoop (R={}, B={}, n_blocks={}, M=1):",
            r, b, n_blocks
        );
        ...
        eprintln!("    v0 baseline: 2292.0 µs (Phase B.0 fused GEMV)");
        eprintln!(
            "    speedup vs v0: {:.3}x",
            2292.0 / per_call_us
        );
